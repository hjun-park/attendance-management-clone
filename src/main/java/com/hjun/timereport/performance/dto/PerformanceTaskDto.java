...
public class PerformanceTaskDto {
	...
	@Builder
	public PerformanceTaskDto(Long perfId, int seq, Double taskHour, String groupMainId, String groupSubId,
	...
	public PerformanceTaskDto EntityToDto(Performance performance) {
